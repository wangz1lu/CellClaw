...
- Python 3.9+
- A Discord bot token ([create one here](https://discord.com/developers/applications))  ([Refer to the first 4 steps for a quick setup in this link.](https://docs.openclaw.ai/channels/discord](https://github.com/wangz1lu/CellClaw/blob/main/README.md#discord-quick-setup))
