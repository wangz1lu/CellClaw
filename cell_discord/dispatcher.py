...
class CommandDispatcher:
    ...
    def _global_help(self) -> str:
        return (
            ...
            "```\n"
            "/skill list                     — List all installed skills\n"
            "/skill info <skill_id>          — View skill knowledge base\n"
            "/skill use  <skill_id> <task>   — Force activate skill\n"
            "/skill run  <skill_id> <task>    — Same as /skill use\n"
            "```\n"
            "**Memory**\n"
            "```\n"
            ...
            "> Run cell-cell communication analysis on ~/data/pbmc.h5ad\n"
            "> What analyses can you do?\n"
            "> How many cells in cluster 3?\n"
            "> Run complete scRNA-seq analysis pipeline\n"
            "> Remember: our data is at /data/project_A/"
        )
